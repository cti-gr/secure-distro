...
self.port.on('optionsBugListUpdated', function (msg) {
	...
	Ghostery.bugBrowser.categories.reset(
		getCategories(msg.bugdb, msg.conf.selected_app_ids, msg.tagDb)
	);

	Ghostery.bugBrowser.initializeTags();

	Ghostery.lsoBrowser.categories.reset(
		getCategories(msg.lsodb, msg.conf.selected_lsos_app_ids, msg.tagDb, true)
	);
